...
2. Separate the dataset into independent variable (X) and dependent variable (y).
3. Train the Simple Linear Regression model using Scikit-learn
4. Predict the results, evaluate the model, and visualize the regression line.
...
## Output:
<img width="1344" height="706" alt="Screenshot 2026-04-24 143837" src="https://github.com/user-attachments/assets/ef3f5677-bc97-49ba-9291-c4c7401d6d38" />
